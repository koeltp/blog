...
[Github](https://github.com/Kele-Bingtang/vitepress-theme-teek) ｜ [Gitee](https://gitee.com/kele-bingtang/vitepress-theme-teek) ｜ [Preview](https://notes.teek.top/) ｜[Docs](http://www.taipi.top/)
...
Please see [Quick Start](https://www.taipi.top/guide/quickstart).

## Contribution Guide

Please see [Contribution Guide](https://www.taipi.top/guide/contribution).
...
Only some effect images are listed below. For more features, please visit [Official Documentation](https://www.taipi.top)
...
QR codes not displaying properly? Click [here](https://www.taipi.top/personal.html) 😎
