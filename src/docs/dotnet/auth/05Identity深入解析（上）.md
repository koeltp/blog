...
```csharp title="ApplicationUser.cs"
...
```csharp title="CustomUserStore.cs"
...
```csharp title="调整 SecurityStamp 验证间隔"
...
```csharp title="UserServiceTest.cs"
...
```csharp title="AuthorizationTest.cs"
[Fact]
