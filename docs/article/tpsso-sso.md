...
```csharp name="AuthorizationController.cs - Authorize"
[HttpGet("authorize")]
[HttpPost("authorize")]
...
```csharp name="AuthorizationController.cs - Exchange"
[HttpPost("token")]
...
```csharp name="AuthorizationController.cs - Logout"
[HttpGet("logout")]
[HttpPost("logout")]
...
```csharp name="AccountController.cs"
[HttpPost("login")]
...
```typescript name="router/index.ts"
