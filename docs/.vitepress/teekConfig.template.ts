/**
 * 这是一个 Teek 配置文件模板，涵盖 Teek 95% 的配置项，更多配置项示例请看 https://www.taipi.top/reference/config.html 专题
 *
  ...
  footerGroup: [
    {
      title: "外部链接",
      links: [
        { name: "示例 1", link: "https://www.taipi.top", icon: "icon-github" },
        { name: "示例 2", link: "https://www.taipi.top" },
        { name: "示例 3", link: "https://www.taipi.top" },
      ],
    },
    {
      title: "内部链接",
