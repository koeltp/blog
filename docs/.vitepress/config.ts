...
export default defineConfig({
  ...
  head: [
    ...
    ["meta", { property: "og:title", content: "TaiPi.Top | 太皮的博客" }],
    ["meta", { property: "og:site_name", content: "太皮的博客" }],
    ["meta", { property: "og:image", content: "https://www.taipi.top/teek-logo-large.png" }],
    ["meta", { property: "og:url", content: "https://www.taipi.top" }],
    ...
    ["meta", { name: "baidu-site-verification", content: "codeva-PpnGOk13Pl" }], // 百度收录
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "登录页", link: "/login" },
          { text: "风险链接提示页", link: "/risk-link?target=https://www.taipi.top" },
