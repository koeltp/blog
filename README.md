...
请看 [快速开始](https://www.taipi.top/guide/quickstart)。

## 贡献指南

请看 [贡献指南](https://www.taipi.top/guide/contribution)。
...
下面只列出部分效果图，更多的功能请访问 [官方文档](https://www.taipi.top)
...
二维码没有正常显示？点 [这里](https://www.taipi.top/personal.html) 😎
